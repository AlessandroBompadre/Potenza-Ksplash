 ...
 *
 *   Alessandro Bompadre (C) 2014  <alessandro.bompadre(at)gmail.com>
 *
...
*/
    ...
    Text {
	  id: loadingText
            ...
            text: '<font color="white"><b>L</b>oading desktop environment by <b>KDE</b>...</font>'
     ...
     Text {
	  id: message
            // HTML like markup can also be used
            text: '<font color="white">Welcome to Kde</font>'
    ...
    Text {
	  id: freedom
            // HTML like markup can also be used
            text: '<font color="white"><i>Beautified by Potenza iconset</i></font>'
     ...
     Text {
	  id: textKDESC
            // HTML like markup can also be used
	     text: '<font color="white">For Linux <b>O</b>s</font>'
